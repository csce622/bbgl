...
#ifndef BIPARTITE_GRAPH_CONCEPTS_HPP
#define BIPARTITE_GRAPH_CONCEPTS_HPP
...
namespace boost {
    ...
    template <typename G>
    struct graph_traits {
        typedef typename G::vertex_descriptor_1      vertex_descriptor_1;
        typedef typename G::vertex_descriptor_2      vertex_descriptor_2;
        typedef typename G::edge_descriptor_1        edge_descriptor_1;
        typedef typename G::edge_descriptor_2        edge_descriptor_2;
        typedef typename G::adjacency_iterator     adjacency_iterator;
        typedef typename G::out_edge_iterator      out_edge_iterator;
        typedef typename G::in_edge_iterator       in_edge_iterator;
        typedef typename G::vertex_iterator_1        vertex_iterator_1;
        typedef typename G::vertex_iterator_2        vertex_iterator_2;
        typedef typename G::edge_iterator_1          edge_iterator_1;
        typedef typename G::edge_iterator_2          edge_iterator_2;
...
#endif // BIPARTITE_GRAPH_CONCEPTS_HPP
