/**
 *
 * Boost Bipartite Graphs Library
 *
 *
 *
 * Project for CSCE-622 Generic Programing class project at Texas A&M University
 *
 * Authors: Varun R, Narottam J & Damien L-G
 * Instructor: Jaakko Jarvi
 * 
 * @author Damien L-G <lebrungd@neo.tamu.edu>
 * @date Oct 22, 2010
 * @version 0.0 (alpha)
 * @todo Finish writing the class :D
 * @note basically almost just a copy and paste from BGL so far...
 *
 */

#ifndef BIPARTITE_GRAPH_TRAITS_HPP
#define BIPARTITE_GRAPH_TRAITS_HPP
...
namespace boost {
    ...
    template <typename G>
    struct bipartite_graph_traits {
        typedef typename G::vertex_descriptor      vertex_descriptor_1;
        typedef typename G::vertex_descriptor      vertex_descriptor_2;
        typedef typename G::edge_descriptor        edge_descriptor_1;
        typedef typename G::edge_descriptor        edge_descriptor_2;
        typedef typename G::adjacency_iterator     adjacency_iterator;
        typedef typename G::out_edge_iterator      out_edge_iterator;
        typedef typename G::in_edge_iterator       in_edge_iterator;
        typedef typename G::vertex_iterator        vertex_iterator_1;
        typedef typename G::vertex_iterator        vertex_iterator_2;
        typedef typename G::edge_iterator          edge_iterator_1;
        typedef typename G::edge_iterator          edge_iterator_2;
...
#endif // BIPARTITE_GRAPH_TRAITS_HPP